! function(e, t) {
    ...
    return function(e) {
        ...
        "object" === ("undefined" == typeof document ? "undefined" : L(document)) && ((o = document.createElement("style")).className = r, o.appendChild(document.createTextNode(s)), document.head.appendChild(o));
        var F = "fslightbox-types",
            I = "fslightbox-scrollbar-width";
        ...
        function C(e) {
            ...
            n.disableLocalStorage ? (this.getSourceTypeFromLocalStorageByUrl = function() {}, this.handleReceivedSourceTypeForUrl = function() {}) : (t = JSON.parse(localStorage.getItem(F))) || (t = {}, this.getSourceTypeFromLocalStorageByUrl = i)
        }
        var E = "image",
            T = "video",
            A = "youtube",
        ...
        function R(e, t) {
            var n = e.collections.sourcesLoadsHandlers,
                ...
                i = o.sourcesInners,
                r = e.props.sources;
            s[t] = document.createElement("img"), s[t].className = S, s[t].src = r[t], s[t].onload = n[t].handleImageLoad, i[t].appendChild(s[t])
        }
        ...
        function M(e, t) {
            var n = e.collections.sourcesLoadsHandlers,
                ...
                r = o.sourcesInners,
                c = e.props.sources;
            s[t] = document.createElement("iframe"), s[t].className = "".concat(S, " ").concat(i, "youtube-iframe"), s[t].src = "https://www.youtube.com/embed/".concat(c[t].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2]), s[t].allowFullscreen = !0, r[t].appendChild(s[t]), n[t].handleYoutubeLoad()
        }
        ...
        function P(e, t) {
            var n = e.collections.sourcesLoadsHandlers,
                ...
                r = e.props,
                c = r.sources;
            s[t] = c[t], s[t].classList.add(S), r.customClasses[t] && s[t].classList.add(r.customClasses[t]), i[t].appendChild(s[t]), n[t].handleCustomLoad()
        }
        ...
        function W(e, t) {
            var n = e.elements,
                ...
                r = n.sourcesOuters;
            e.props.sources;
            o[t] = document.createElement("div"), o[t].className = "".concat(i, "invalid-file-wrapper ").concat(l), o[t].innerHTML = "Invalid source", s[t].classList.add(v), s[t].appendChild(o[t]), r[t].removeChild(r[t].firstChild)
        }
        ...
        function Y(e, t) {
            var n = e.elements,
                ...
                s = n.sourcesOuters;
            s[t] = document.createElement("div"), s[t].className = "".concat(w, " ").concat(p, " ").concat(a, " ").concat(l), s[t].innerHTML = '<div class="fslightbox-loader"><div></div><div></div><div></div><div></div></div>', o.appendChild(s[t]),
                function(e, t) {
                    var n = e.elements,
                        o = n.sourcesOuters,
                        s = n.sourcesInners;
            ...
            n.className = "".concat(i, "toolbar"), t.appendChild(n),
                function(e, t) {
                    var n, o = e.core.fullscreenToggler,
                        ...
                        a = B(t);
                    i.isFullscreenOpen = !!document.fullscreenElement, i.isFullscreenOpen ? (n = U(a, "24px", "0 0 950 1024", c), a.title = "Exit fullscreen") : (n = U(a, "20px", "0 0 18 18", r), a.title = "Enter fullscreen"), s.enterFullscreen = function() {
        ...
        function G(e, t, n, o) {
            ...
            r.className = "".concat(h, " ").concat(h, "-").concat(n), r.title = "".concat(i, " slide"), r.onclick = t,
                function(e, t) {
                    var n = document.createElement("div");
        ...
        function Q(e) {
            ...
            this.isLightboxFadingOut = !1, this.runActions = function() {
                t.isLightboxFadingOut = !0, a.container.classList.add(b), i.removeListeners(), c.isFullscreenOpen && s.exitFullscreen(), setTimeout((function() {
                    t.isLightboxFadingOut = !1, l.isSwiping = !1, a.container.classList.remove(b), document.documentElement.classList.remove(u), r.removeRecompense(), document.body.removeChild(a.container), o.dispatch("onClose")
                }), K - 30)
            }
        }
        var $ = "sourcesOuters",
        ...
        function te(e) {
            ...
            a.changeTo = function(e) {
                ...
                var t = f.current;
                a.changeTo(e), c.removeFromEachElementClassIfContains($, d), Z(p[t], v), Z(p[t], g), p[t].classList.add(m), Z(p[e], v), Z(p[e], m), p[e].classList.add(g), h(), s[e].zero(), setTimeout((function() {
        ...
        function se(e) {
            ...
            this.runActionsForEvent = function(e) {
                var t, r, a;
                n.container.contains(n.slideSwipingHoverer) || n.container.appendChild(n.slideSwipingHoverer), t = n.container, r = c, (a = t.classList).contains(r) || a.add(r), o.swipedX = ne(e) - o.downClientX, i(s.current, "zero"), void 0 !== s.previous && o.swipedX > 0 ? i(s.previous, "negative") : void 0 !== s.next && o.swipedX < 0 && i(s.next, "positive")
            };
            var i = function(e, n) {
        ...
        function ce(e) {
            ...
            this.runNoSwipeActions = function() {
                ...
                s.swipedX > 0 ? i.runPositiveSwipedXActions() : i.runNegativeSwipedXActions(), n.container.contains(n.slideSwipingHoverer) && n.container.removeChild(n.slideSwipingHoverer), n.container.classList.remove(c), s.isSwiping = !1
            }
        }
            ...
            n = (t = e).core.classFacade, o = t.elements, n.removeFromEachElementClassIfContains = function(e, t) {
                ...
                function(e) {
                    ...
                    o.listener = function(e) {
                        ...
                        var t = s[r.current];
                        t && t.contains(e.target) ? i.isSourceDownEventTarget = !0 : i.isSourceDownEventTarget = !1, n.removeFromEachElementClassIfContains($, d)
                    }
                }(e),
                function(e) {
                ...
                function(e) {
                    ...
                    s.runActions = function() {
                        ...
                        for (var e = 0; e < a.sources.length; e++) Z(c[e], d), e !== l.current && n[e].negative(), o[e] && o[e].styleSize()
                    }
                }(e)
        }
            ...
            n.isInitialized = !0,
                ...
                function(e) {
                    var t = e.core.slideSwipingDown,
                        n = e.elements,
                        o = e.props.sources;
                    n.sourcesOutersWrapper = document.createElement("div"), n.sourcesOutersWrapper.className = "".concat(p, " ").concat(a), n.container.appendChild(n.sourcesOutersWrapper), n.sourcesOutersWrapper.addEventListener("mousedown", t.listener), n.sourcesOutersWrapper.addEventListener("touchstart", t.listener, {
                        passive: !0
                    });
                ...
                function(e) {
                    for (var t = e.props.sources, n = e.resolve, o = n(C), s = n(X), i = n(V, [o, s]), r = 0; r < t.length; r++)
        ...
        function de(e) {
            ...
            i.open = function() {
                ...
                h.current = o, p.isInitialized ? s.dispatch("onShow") : ue(e), l.updateStageIndexes(), a.displayStageSourcesIfNotYet(), n.setSlideNumber(h.current + 1), document.body.appendChild(f.container), document.documentElement.classList.add(u), c.addRecompense(), r.attachListeners(), s.dispatch("onOpen"), t[h.current].zero(), d.runActions()
            }
        }
